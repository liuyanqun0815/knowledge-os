...
# 后端（Windows 上若多次 reload 可能残留旧进程，文档列表轮询/单文档 GET 会 405；先结束多余 uvicorn 再启动）
uv run uvicorn akos.interfaces.api.main:create_app --factory --host 127.0.0.1 --port 8000
